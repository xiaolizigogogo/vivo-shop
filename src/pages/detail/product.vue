...
<style lang="scss" scoped>
    ...
    .product-header-container {
      ...
      .other {
        ...
        .share {
          ...
          width: .65rem;
          height: .65rem;
          background: url('../../assets/jd/images/shares.png') no-repeat;
          background-size: 100%;
        }
        .menu {
          display: block;
          ...
          margin-left: .2rem;
          height: .65rem;
          background: url('../../assets/jd/images/menu.png') no-repeat;
          background-size: 100%;
        }
      }
    }
  ...
  #mainLayout {
    ...
    .product-sku {
      ...
      .right-menu {
        width: 19px;
        height: 4px;
        background-image: url('../../assets/jd/images/product-detail-sprites-mjs.png');
          ...
          .comment-userinfo {
            ...
            .comment-star {
              ...
              .star-item {
                ...
                width: 14px;
                height: 14px;
                background: url('../../assets/jd/images/star-h.png') no-repeat;
                background-size: 100%;
              }
            }
          }
  ...
  .cart-concern-fixed {
    ...
    .left {
      ...
      .goods-part {
        i {
          background: url('../../assets/jd/images/store.png') no-repeat;
          background-size: 90%;
      ...
      .like-icon {
        i {
          background: url('../../assets/jd/images/cart_sprits_all.png') no-repeat;
    ...
    .goodcomment-item {
      ...
      .comment-other {
        ...
        >div {
          ...
          .sendcomment {
            i {
              background: url('../../assets/jd/images/evaluated.png') no-repeat;
              background-size: 100%;
            }
          }
        }
...
<template>
  <div style="background:#f8f8f8;" class="product">
    ...
    <div class="cart-concern-fixed">
      <div class="left">
        <div class="goods-part" @click="$router.push('/home')">
          <i></i>
          <span>首页</span>
        </div>
      ...
      <div class="right" @click="add(productInfo)">加入购物车</div>
    </div>
    <!-- 底部导航栏 -->
...
<script>
  ...
  add: function(index) {
    var data = {
      ...
      number:1,
      checked:true,
      listPicUrl:index.listPicUrl,
      marketPrice:index.retailPrice,
      retailPrice:index.retailPrice,
